...
export const UserProfileView: React.FC<UserProfileViewProps> = ({ username, onClose, onSelectRepo }) => {
  ...
  if (loading) return (
    <div className="fixed inset-0 z-[120] bg-white dark:bg-slate-950 flex flex-col items-center justify-center gap-6">
      <div className="w-24 h-24 bg-slate-100 dark:bg-slate-900 rounded-[2.5rem] animate-pulse" />
      <div className="space-y-2 text-center">
        <div className="h-6 w-32 bg-slate-100 dark:bg-slate-900 rounded animate-pulse" />
        <div className="h-4 w-48 bg-slate-100 dark:bg-slate-900 rounded animate-pulse" />
      </div>
    </div>
  );
           ...
           <div className="space-y-4">
              ...
              <div className="flex gap-4">
                 <div className="flex-1 bg-white dark:bg-slate-900 p-4 rounded-[2rem] border border-slate-100 dark:border-slate-800 text-center">
                    <div className="text-lg font-black italic">{user.followers}</div>
                    <div className="text-[8px] font-black text-slate-400 uppercase tracking-widest">FOLLOWERS</div>
                 </div>
                 <div className="flex-1 bg-white dark:bg-slate-900 p-4 rounded-[2rem] border border-slate-100 dark:border-slate-800 text-center">
                    <div className="text-lg font-black italic">{user.following}</div>
